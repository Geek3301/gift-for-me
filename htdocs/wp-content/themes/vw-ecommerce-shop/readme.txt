...
= 0.8.5 =
  -- Added go pro button in footer and trending product section in customizer.
...
= 0.9.1 =
  ...
  -- Removed blog post time, comment, author option in customizer.
  -- Updated language folder.
...
= 1.1.8 =
  ...
  -- Added theme bundle button in customizer.
  -- Added show /hide preloader for responsive setting.
  -- Resolved css error for footer in responsive media.
  -- Added css for proceed to checkout button in responsive media.
  -- Resolved css error for myaccount address page.
  -- Tested upto WP v6.6.
  -- Updated pot file.
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-ecommerce-lite/