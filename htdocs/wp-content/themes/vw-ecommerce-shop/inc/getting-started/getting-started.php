...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="vw_ecommerce_shop_open_tab(event, 'get_bundle')"><?php esc_html_e( 'Get 250+ Themes Bundle at $99', 'vw-ecommerce-shop' ); ?></button>
		</div>
			...
			<div class="lite-theme-tab" style="<?php echo esc_attr($vw_ecommerce_shop_plugin_custom_css); ?>">
				...
				<div class="col-right-inner">
	                ...
	                <ul>
	                  	...
	                  	<p><?php esc_html_e(' Once you are done with this, then follow the','vw-ecommerce-shop'); ?> <a class="doc-links" href="https://preview.vwthemesdemo.com/docs/free-vw-ecommerce-lite/" target="_blank"><?php esc_html_e('Documentation','vw-ecommerce-shop'); ?></a></p>
	                </ul>
			  	</div>
			</div>
		</div>	
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_ecommerce_shop_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-ecommerce-shop'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','vw-ecommerce-shop'); ?></span></b></p>
			    	...
			    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','vw-ecommerce-shop'); ?></span></b></p>
		...
		<div id="pro_theme" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VW_ECOMMERCE_SHOP_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Get 250+ Themes Bundle at $99', 'vw-ecommerce-shop'); ?></a>
				</div>
		    </div>
		...
		<div id="get_bundle" class="tabcontent">		  	
		   <div class="col-left-pro">
		   	<h3><?php esc_html_e( 'WP Theme Bundle', 'vw-ecommerce-shop' ); ?></h3>
		    	<p><?php esc_html_e('Enhance your website effortlessly with our WP Theme Bundle. Get access to 250+ premium WordPress themes and 5+ powerful plugins, all designed to meet diverse business needs. Enjoy seamless integration with any plugins, ultimate customization flexibility, and regular updates to keep your site current and secure. Plus, benefit from our dedicated customer support, ensuring a smooth and professional web experience.','vw-ecommerce-shop'); ?></p>
		    	<div class="feature">
		    		<h4><?php esc_html_e( 'Features:', 'vw-ecommerce-shop' ); ?></h4>
		    		<p><?php esc_html_e('250+ Premium Themes & 5+ Plugins.', 'vw-ecommerce-shop'); ?></p>
		    		<p><?php esc_html_e('Seamless Integration.', 'vw-ecommerce-shop'); ?></p>
		    		<p><?php esc_html_e('Customization Flexibility.', 'vw-ecommerce-shop'); ?></p>
		    		<p><?php esc_html_e('Regular Updates.', 'vw-ecommerce-shop'); ?></p>
		    		<p><?php esc_html_e('Dedicated Support.', 'vw-ecommerce-shop'); ?></p>
		    	</div>
		    	<p>Upgrade now and give your website the professional edge it deserves, all at an unbeatable price of $99!</p>
		    	<div class="pro-links">
					<a href="<?php echo esc_url( VW_ECOMMERCE_SHOP_THEME_BUNDLE_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'vw-ecommerce-shop'); ?></a>
					<a href="<?php echo esc_url( VW_ECOMMERCE_SHOP_THEME_BUNDLE_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'vw-ecommerce-shop'); ?></a>
				</div>
		   </div>
		   <div class="col-right-pro">
