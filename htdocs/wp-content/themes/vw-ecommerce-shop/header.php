...
<header role="banner">
  ...
  <?php if( get_theme_mod( 'vw_ecommerce_shop_topbar_hide_show', false) == 1 || get_theme_mod( 'vw_ecommerce_shop_resp_topbar_hide_show', false) == 1) { ?>
    <div class="topbar">
      <div class="container">
        <div class="row">
  ...
  <div class="header">
            ...
            <?php $blog_info = get_bloginfo( 'name' ); ?>
              <?php if ( ! empty( $blog_info ) ) : ?>
                <?php if ( is_front_page() && is_home() ) : ?>
                  <?php if( get_theme_mod('vw_ecommerce_shop_logo_title_hide_show',true) == 1){ ?>
              ...
              ?>
              <?php if( get_theme_mod('vw_ecommerce_shop_tagline_hide_show',false) == 1){ ?>
    ...
    <div class="menubox <?php if( get_theme_mod( 'vw_ecommerce_shop_sticky_header', false) == 1 || get_theme_mod( 'vw_ecommerce_shop_stickyheader_hide_show', false) == 1) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
      <div class="container">
        <div class="row m-0">
...
<?php if(get_theme_mod('vw_ecommerce_shop_loader_enable',false) == 1 || get_theme_mod('vw_ecommerce_shop_responsive_preloader_hide',false) == 1) { ?>
  <div id="preloader">
